...
const Home = () => {
  ...
  return (
    <div className="content-home">
      ...
      <p>{"And of course, don't forget to subscribe to our mailing list"}</p>
      <p>{"Passionately yours. Rene Fernandez"}</p>
      <div className="full">{"Opening Hours"}</div>
      <div className="full" style={dayStyles}>
        {"Monday to Thursday"}
      </div>
      <div className="full">{"11:00 AM to 9:30 PM"}</div>
      <div className="full" style={dayStyles}>
        {"Friday & Saturday"}
      </div>
      <div className="half">{"Restaurant"}</div>
      <div className="half">{"11:00 AM to 10:00 PM"}</div>
      <div className="half">{"Music ($5 cover)"}</div>
      <div className="half">{"10:00 PM to 2:00 AM"}</div>
      <div className="full" style={dayStyles}>
        {"Sunday"}
      </div>
      <div className="half">{"Dinner"}</div>
      <div className="half">{"4:00 PM  to  9:30 PM"}</div>
    </div>
  );
};
