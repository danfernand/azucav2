...
const Reservations = () => {
  return (
    <div className="content-reservations">
      <p>{"Please use our online reservation system below"}</p>
      <div style={{ maxWidth: "350px", margin: "0px auto" }}>
        <iframe
          title="order now"
          id="widget"
          height="410"
          src="https://www.reservationgenie.com/restaurants/298-azuca-nuevo-latino-san-antonio/widget/vertical_full"
      ...
      <p>
        {"Call "}
        <a href="tel:+12102255550">{"210-225-5550"}</a>
      ...
      <p>{"Reservations are not accepted in the Bar Area."}</p>
      ...
      <p>{"Friday – Saturday, 11:30pm – 10:30pm"}</p>
